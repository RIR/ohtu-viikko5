...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.kuuluuLukujoukkoon(10));
        assertFalse(joukko.kuuluuLukujoukkoon(5));
        assertTrue(joukko.kuuluuLukujoukkoon(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.kuuluuLukujoukkoon(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        joukko.poista(11);
        assertFalse(joukko.kuuluuLukujoukkoon(11));
